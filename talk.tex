  ...
  \begin{columns}
    ...
    \column{0.5\linewidth}
      \begin{itemize}
        ...
        \vspace{0.2cm}
        \begin{itemize}
          \item<2-> Consecutive lattice sites $x$ separated by e.g. \mintinline{c++}{4 * sizeof(su3)} or \mintinline{c++}{sizeof(spinor)} in memory.
        \end{itemize}
        \vspace{0.6cm}
...
Kokkos::fence();
    ...
    \column{0.4\textwidth}
        \begin{block}{2D View}
          Logical index order \mintinline{c++}{a(i,j)} transparently maps to (in memory)
            \begin{itemize}
              \item \mintinline{c++}{i} running fastest on GPU
              \vspace{0.3cm}
              \item \mintinline{c++}{j} running fastest on CPU 
              \vspace{0.3cm}
              \begin{itemize}
...
\begin{frame}[fragile]{Writing simple kernels}
  ...
  \begin{itemize}
  \vspace{0.4cm}
  \item Views of structs, e.g. \mintinline{c++}{su3_t arr[mu][i]}, \mintinline{c++}{spinor_t arr[i]} (with operator overloads on \mintinline{c++}{su3_t} and \mintinline{c++}{spinor_t}) would break coalescing on GPU. 
  \vspace{0.3cm}
...
\begin{frame}[fragile]{Expression Templates}{current status}

  Expression templates for view level operations have been tested\\
...
\begin{figure}[!ht]
  ...
  \draw [ fill={rgb,255:red,211; green,211; blue,211} , line width=1pt , rounded corners = 15.6] (0.5,5.25) rectangle (26.75,-9.75);
  \node [font=\Huge] at (13.75,3) {=};
  \draw [ fill={rgb,255:red,86; green,180; blue,233} , line width=1pt , rounded corners = 15.6] (15.5,3.75) rectangle (24.5,2);
  \node [font=\Huge] at (20,3) {expr.operator()};
  \draw [ fill={rgb,255:red,233; green,139; blue,86} , line width=1pt , rounded corners = 15.6] (3,3.75) rectangle (12,2);
  \node [font=\Huge] at (7.5,3) {out.operator()};
  \draw [ fill={rgb,255:red,86; green,180; blue,233} , line width=1pt , rounded corners = 15.6] (15.25,-2) rectangle (24.5,-8.5);
  \draw [ fill={rgb,255:red,0; green,158; blue,115} , line width=1pt , rounded corners = 15.6] (15.5,-2.25) rectangle (24.25,-4.5);
  \draw [ fill={rgb,255:red,0; green,158; blue,115} , line width=1pt , rounded corners = 15.6] (15.5,-5.75) rectangle (24.25,-8);
  \node [font=\Huge] at (20,-6.75) {chi.operator()};
  \node [font=\Huge] at (19.75,-3.25) {phi.operator()};
  \node [font=\Huge] at (19.75,-5.25) {\textbf{+}};
  \draw [ fill={rgb,255:red,86; green,180; blue,233} , line width=1pt , rounded corners = 15.6] (2.75,-2) rectangle (12,-8.5);
  \draw [ fill={rgb,255:red,0; green,158; blue,115} , line width=1pt , rounded corners = 15.6] (3,-2.25) rectangle (11.75,-4.5);
  \draw [ fill={rgb,255:red,0; green,158; blue,115} , line width=1pt , rounded corners = 15.6] (3,-5.75) rectangle (11.75,-8);
  \draw [ fill={rgb,255:red,233; green,139; blue,86} , line width=1pt , rounded corners = 15.6] (3.25,-2.5) rectangle (11.5,-4.25);
  \draw [ fill={rgb,255:red,233; green,139; blue,86} , line width=1pt , rounded corners = 15.6] (3.25,-6) rectangle (11.5,-7.75);
  \node [font=\Huge] at (7.5,-3.25) {phi.view.operator()};
  \node [font=\Huge] at (7.25,-6.75) {chi.view.operator()};
  \node [font=\Huge] at (7.25,-5.25) {\textbf{+}};
  \draw [line width=1pt, ->, >=Stealth, dashed] (19.75,2) -- (19.75,-1.75);
  \draw [line width=1pt, ->, >=Stealth, dashed] (17.25,-3.25) -- (10.75,-3.25);
  \draw [line width=1pt, ->, >=Stealth, dashed] (17.5,-6.75) -- (10.75,-6.75);
  \draw [line width=1pt, ->, >=Stealth, dashed] (7.5,-2) -- (7.5,1.75);
  \node [font=\Huge] at (21.25,0.25) {returns};
  \node [font=\Huge] at (13.5,-2.75) {returns};
  \node [font=\Huge] at (13.5,-6.25) {returns};
  \node [font=\Huge] at (9.5,0.25) {assigns to};
  %\node [font=\Huge] at (4.5,4.5) {\underline{AssignField.operator()}};
  \end{circuitikz}
  }
  % \caption{\label{fig::assignment_diagram}Control flow diagram of the evaluation and the assignment of the expression representing the addition of two \texttt{Fields} in the functor \texttt{AssignField}.}
\end{figure}
...
\begin{frame}{Benchmark: Expression Templates}{Marvin - cpu}
...
\begin{frame}{Benchmark: Expression Templates}{gpus}
...
\begin{frame}{Kronos: some more kernels}
...
\begin{frame}[fragile]{Meson 2-point correlator}
...
\begin{frame}{Backup: A first correlator}
